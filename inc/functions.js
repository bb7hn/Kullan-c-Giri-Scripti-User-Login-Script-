					...
					$.ajax	({
							...
							{// gonderme işlemi başarılı ise sonuc değişkeni ile gelen değerleri aldık	
								if(sonuc==0)//0 değeri döndüyse
								{
									$("body").overhang({
										type: "Success",
										message:"Kayıt işlemi başarı ile gerçekleşti anasayfaya yönlendiriliyorsunuz..."
									});//giriş başarılı mesajı verip
									setTimeout(function(){ $('body').load('main.php'); }, 3000);//anasayfaya yönlendiriyoruz
								}
